...
highlight :: proc(filepath: string, file_content: string, text_cols: [TextColorID][4]f32) -> [][4]f32 {
...
highlight_c :: proc(filepath: string, file_content: string, colors: ^[][4]f32, text_cols: [TextColorID][4]f32) {

}

highlight_bat :: proc(filepath: string, file_content: string, colors: ^[][4]f32, text_cols: [TextColorID][4]f32) {
